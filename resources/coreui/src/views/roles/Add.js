...
export default class Add extends Component {
  constructor(props) {
    ...
    this.state = {
      libelle: '',
      roles: [],
      message:'Veuillez ajoutez un role qui n\'existe pas'
  ...
  handlesubmitform=(event)=>{
    ...
    axios.post('/api/roles/checkRole',{
      data:
        {
                 ...
                 <div className="row">
                   ...
                   {this.state.roles &&this.state.roles.length>0?this.state.roles.map((role)=>{
                     return(
                       ...
                       <span className="badge badge-danger" style={{padding:10,marginLeft:20,fontSize:12,marginTop: 8}}>{role.libelle}</span>
